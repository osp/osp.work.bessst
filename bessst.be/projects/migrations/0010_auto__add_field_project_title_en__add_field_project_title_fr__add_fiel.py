...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('projects_project', 'title_en',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'Project.title_fr'
        db.add_column('projects_project', 'title_fr',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'Project.subtitle_en'
        db.add_column('projects_project', 'subtitle_en',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Project.subtitle_fr'
        db.add_column('projects_project', 'subtitle_fr',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Project.location_en'
        db.add_column('projects_project', 'location_en',
                      self.gf('django.db.models.fields.CharField')(max_length=80, null=True),
                      keep_default=False)

        # Adding field 'Project.location_fr'
        db.add_column('projects_project', 'location_fr',
                      self.gf('django.db.models.fields.CharField')(max_length=80, null=True),
                      keep_default=False)

        # Adding field 'Project.summary_en'
        db.add_column('projects_project', 'summary_en',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Project.summary_fr'
        db.add_column('projects_project', 'summary_fr',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Project.description_en'
        db.add_column('projects_project', 'description_en',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'Project.description_fr'
        db.add_column('projects_project', 'description_fr',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('projects_project', 'title_en')

        # Deleting field 'Project.title_fr'
        db.delete_column('projects_project', 'title_fr')

        # Deleting field 'Project.subtitle_en'
        db.delete_column('projects_project', 'subtitle_en')

        # Deleting field 'Project.subtitle_fr'
        db.delete_column('projects_project', 'subtitle_fr')

        # Deleting field 'Project.location_en'
        db.delete_column('projects_project', 'location_en')

        # Deleting field 'Project.location_fr'
        db.delete_column('projects_project', 'location_fr')

        # Deleting field 'Project.summary_en'
        db.delete_column('projects_project', 'summary_en')

        # Deleting field 'Project.summary_fr'
        db.delete_column('projects_project', 'summary_fr')

        # Deleting field 'Project.description_en'
        db.delete_column('projects_project', 'description_en')

        # Deleting field 'Project.description_fr'
        db.delete_column('projects_project', 'description_fr')
