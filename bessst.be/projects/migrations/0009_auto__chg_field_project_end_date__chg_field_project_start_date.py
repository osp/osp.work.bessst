...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('projects_project', 'start_date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Project.end_date'
        db.alter_column('projects_project', 'end_date', self.gf('django.db.models.fields.DateField')(default=''))

        # Changing field 'Project.start_date'
        db.alter_column('projects_project', 'start_date', self.gf('django.db.models.fields.DateField')(default=''))
