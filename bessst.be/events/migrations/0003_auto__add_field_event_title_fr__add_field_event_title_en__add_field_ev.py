...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.title_fr'
        db.add_column('events_event', 'title_fr',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Event.title_en'
        db.add_column('events_event', 'title_en',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Event.summary_fr'
        db.add_column('events_event', 'summary_fr',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Event.summary_en'
        db.add_column('events_event', 'summary_en',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Event.description_fr'
        db.add_column('events_event', 'description_fr',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Event.description_en'
        db.add_column('events_event', 'description_en',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.title_fr'
        db.delete_column('events_event', 'title_fr')

        # Deleting field 'Event.title_en'
        db.delete_column('events_event', 'title_en')

        # Deleting field 'Event.summary_fr'
        db.delete_column('events_event', 'summary_fr')

        # Deleting field 'Event.summary_en'
        db.delete_column('events_event', 'summary_en')

        # Deleting field 'Event.description_fr'
        db.delete_column('events_event', 'description_fr')
